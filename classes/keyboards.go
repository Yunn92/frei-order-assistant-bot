...
func InlineBar() *tgbotapi.InlineKeyboardMarkup {
	var Keyboard = tgbotapi.NewInlineKeyboardMarkup(
		...
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData("Назад", "back_to_consumables"),
		),
	)
...
func ParseJSONToKeyboard(goods []Goods, point string) *tgbotapi.InlineKeyboardMarkup {
	var Keyboard = tgbotapi.NewInlineKeyboardMarkup()
	...
	tempBack := tgbotapi.NewInlineKeyboardRow(tgbotapi.NewInlineKeyboardButtonData("Назад", point))

	Keyboard.InlineKeyboard = append(Keyboard.InlineKeyboard, tempBack)
